...
namespace core
{
    ...
    {
      $('#aboutHeading').text("Andre Agrippa");
      $('#aboutText').text("I'm a 2nd year student at Durham College in the Computer Programming and Analysis program." +
              "I've been coding for several years now because I enjoy it and always looking to improve in this aspect.");
    }
